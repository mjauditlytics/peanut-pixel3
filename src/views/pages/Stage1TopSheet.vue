...
import Stage1LivePreview from "@/components/Stage1LivePreview.vue";
...
const nextStep = () => {
    if (currentStep.value < steps.value.length - 1) {
        ...
        formStore.updateStep1(formData.value)
        formStore.setActivePage(1);
        router.push("/stage2")
    }
};
...
<template>
    <div class="grid">
        <div class="col-12">
            ...
            <!-- <Steps :model="steps" :readonly="false" :active="formStore.getActivePage()" @select="onStepClick" /> -->
            <div class="card">
                ...
                <div class="grid">
                    <div class="col-5 flex align-items-center justify-content-center">
                        <div class="p-fluid">
                            <div class="field">
                                ...
                                <component :is="currentStepData.component" v-model="formData[currentStepData.field]"
                    ...
                    <div class="col-5 align-items-center justify-content-center">
                        ...
                        <Stage1LivePreview :reportData="formData" />
                    </div>
                </div>
            </div>
